                                      ...
                                      <h2 id=\"CondicionTitulo\" class=\"text-center\" >IMM</h2>  
                                          <div class=\"Resultados2 col-sm-4 col-xs-4\">
                                            	...
                                            	<div class=\"Resultados col-sm-4 col-xs-4 pull-right\">
                                                    ...
                                                    <!--Primeros Resultados -->
                                                	<div class=\"col-sm-12 col-xs-12 Cintura pull-right\">
                                                    <label for=\"\" id=\"\" class=\"text-right col-xs-6 col-sm-6 right\">".$CantidadCintura."</label>
                                                     </div>
                                                    <div class=\"col-sm-12 col-xs-12 Cadera pull-right\">
                                                    	<label for=\"\" id=\"\" class=\"text-right col-xs-6 col-sm-6 right\">". $CantidadCadera."</label>
                                                     </div>
                                                    <div class=\"col-sm-12 col-xs-12 Per_Espalda  pull-right\">
                                                    	<label for=\"\" id=\"\" class=\"text-right col-xs-6 col-sm-6 right\">". $per_espalda_can."</label>
                                                    </div>
                                                    <div class=\"col-sm-12 col-xs-12 Per_Pecho   pull-right\">
                                                    	<label for=\"\" id=\" \" class=\"text-right col-xs-6 col-sm-6 right\">". $Per_Pecho ."</label>
                                                     </div>
                                                    <div class=\"col-sm-21 col-xs-12 Per_Brazo pull-right\">
                                                    	<label for=\"\" id=\"\" class=\"text-right col-xs-6 col-sm-6 right\">". $Per_Brazo."</label>
                                                     </div>
                                                    <div class=\"col-sm-12 col-xs-12 Per_Brazo_Fle pull-right\">
                                                    	<label for=\"\" id=\"\" class=\"text-right col-xs-6 col-sm-6 right\">". $Per_Brazo_Fle."</label>
                                                     </div>
                                                    <div class=\"col-sm-12 col-xs-12 Perimetro_femoral pull-right\">
                                                    	<label for=\"\" id=\"\" class=\"text-right col-xs-6 col-sm-6 right\"col-xs-6 col-sm-6 right>". $Per_Femoral."</label>
                                                     </div>
                                                    <div class=\"col-sm-12 col-xs-12 Per_Pantorrilla pull-right\">
                                                    	<label for=\"\" id=\"\" class=\"text-right col-xs-6 col-sm-6 right\">". $Per_Pantorrilla."</label>
                                                    </div>
                                                    </div><!-- Resultados-->
                                      </div><!--containerbar -->
		</div> <!-- row -->
