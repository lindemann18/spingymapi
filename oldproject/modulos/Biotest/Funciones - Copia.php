<?php
	...
	// Esta copia se hizo el día 02/02/2015, contiene los métodos de crear imagen de los reportes anteriores.
	// Como no eran visualmente atractivos se sustituyen por los métodos actuales que estuvieron de prueba.
	// Es solo un respaldo en caso de contingencias.
	...
	function CondicionFisica($id_Cliente,$ResultadoEvaluado,$id_instructor)
	{
		...
		if($sexo=="MASCULINO")	
		{
			...
			{	
				$salidaJson = AgregadoYfuncionesDeCondicionFisica($id_instructor,$id_Cliente,$Condicion,$ResultadoEvaluado); 
			}
			return $salidaJson;
		}//if
		else
		{
			...
			else{$salidaJson=AgregadoYfuncionesDeCondicionFisica($id_instructor,$id_Cliente,$Condicion,$ResultadoEvaluado); }
			return $salidaJson;
		}
		...
		switch($edad)
			{
				...
				case $edad >=18 && $edad<=25:
						...
						if($res=="" && $resultado>=54 && $resultado<=60) $res="Atleta";
				...
				case $edad >=26 && $edad<=35:
					if($res=="" && $resultado>=54 && $resultado<=59)$res="Atleta";
	...
	function AgregadoYfuncionesDeCondicionFisica($id_instructor,$id_Cliente,$Condicion,$ResultadoEvaluado)
	{
			$agregar=new Agregar();
			$consultar=new Consultar(); 
			//Tomando los valores para guardar el resultado de la prueba en la BD
			$TipoPrueba=1;
			$DescPrueba="condición Física";
	...
	function PorcentajeAcordeResultadoFuerza($resultado)
	{
		switch($resultado)	
		{
			case 'Excelente': 	 $porcentaje = 100; break;
			case 'Bueno': 		 $porcentaje = 80;  break;
			case 'Promedio': 	 $porcentaje = 60;  break;
			case 'Pobre':     	 $porcentaje = 40;  break;
			case 'Muy Pobre':    $porcentaje = 20;  break;
		}//switch
