...
class PDF extends FPDF
{
    ...
    function datosHorizontal($datos)
    {
        ...
        foreach($datos as $fila)
        {
            ...
            $this->CellFitSpace(40,7, utf8_decode($fila['nb_ejercicio']),0, 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['nb_TipoRutina']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['nb_dia']),0, 0 , 'L' );
			$this->CellFitSpace(40,7, utf8_decode($fila['num_Circuitos']),'LR', 0 , 'L' );
			$this->CellFitSpace(40,7, utf8_decode($fila['num_Repeticiones']),'LR', 0 , 'L' );
    ...
    {
		$foto=array('C:/xampp/htdocs/Spinpgym/includes/PDF/logo.jpg');
		 $this->Espacio($foto);
