...
?>
   <table id="listados" class="table table-bordered table-striped">
                                        ...
                                        while($filaRutina=$resultRutinas->fetch_assoc()):
											...
											echo('
                                            <tr onclick="SeleccioinarDato('.$filaRutina['id_rutina'].')" id=fila"'.$filaRutina['id_rutina'].'">
												...
												<td><button type="button" class="btn btn-info" onclick="InfoRutina('.$filaRutina['id_rutina'].')">Info</button></td>
												<td><button type="button" class="btn btn-primary" onclick="AsignarRutina('.$filaRutina['id_rutina'].')">Asignar Rutina</button></td>
                                            </tr>
											');	
