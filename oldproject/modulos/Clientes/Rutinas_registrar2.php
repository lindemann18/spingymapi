...
.Botones {margin-right: 4%;}
  ...
  <strong>Bien Hecho!</strong> Ejercicios Registrado.</div>
                    <h4 class="page-header"> 
                        Formulario De Rutinas Para Clientes
                        <small>
...
{
	//Verificando si se desea continuar con el procedimiento
		...
		if(Tipo_RutinaActual=="Compleja")
		{
			...
			if(Contador==TotalActividades)
			{
				...
				else
				{
					...
					else{window.location='index.php?nav=RutinasClient2&Day='+DiaActual+"&Rut="+Rut;}
				}//else
			} //if Contador==TotalActividades
			else
			{
				...
				window.location='index.php?nav=RutinasClient2&Day='+DiaActual+"&Rut="+Rut;
