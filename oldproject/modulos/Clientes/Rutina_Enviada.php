            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="">Clientes</li>
                         <li class="fa fa-dashboard">Rutina</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <h4 class="page-header">
                        Rutina Enviada
                        <small>
                        	si llegó a este apartado es por que ha enviado una rutina de <span class="text-red">spin gym</span>
                            a un cliente.
                        </small>
                    </h4>
                    <!-- HEADER DEL CONTENIDO-->
                    	...
                    	<div class="col-xs-12">
                            ...
                            <!-- APARTADO DEL FORMULARIO DONDE NO SE HA HECHO LA EVALUACIÓN FÍSICA-->
                                <div class="box-header">
                                    <div class="col-sm-12">
                                    	<h4 class="text-center">La rutinas se ha enviado exitosamente al correo,
                                        	de click en el botón para volver al menú.
                                         </h4>
                                         <input type="hidden" value="<?php echo $id_cliente?>" id="id_cliente">
                                        <div class="col-sm-1 Arriba Izquierda"><button class="btn btn-info btn-sm" id="agregar" title="AGREGAR REGISTRO" data-original-title="AGREGAR REGISTRO" onclick="MenuRutina()"><i class="fa fa-plus"></i> Menú Rutina</button></div>
