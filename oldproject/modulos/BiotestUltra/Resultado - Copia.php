				...
				$('#ContainerBar').html2canvas({
					onrendered: function (canvas) 
					{
						...
						$.post( "modulos/Biotest/Funciones.php", { Params: Params,  } ).done(function (response){
							...
							var objJSON = eval("(function(){return " + response + ";})()");
							CondicionFisicaVar = objJSON.CondicionFisicaVar; //Nombre del archivo de condición física
							Folder_Name		   = objJSON.Folder_Name;		//Folder donde se guardan las fotografías
							
							//Se crea la cookie para mandarlas al pdf y luego eliminar los archivos
							$.cookie("CondicionFisicaVar",CondicionFisicaVar);
							$.cookie("Folder_Name",Folder_Name);
			...
			//Tomando la captura del resultado.
				$('#ContainerBar').html2canvas({
					onrendered: function (canvas) 
					{
						...
						$.post( "modulos/Biotest/Funciones.php", { Params: Params,  } ).done(function (response){
							var objJSON = eval("(function(){return " + response + ";})()");
							PesoVar = objJSON.PesoVar; //Nombre del archivo de condición física
							//Se crea la cookie para mandarlas al pdf y luego eliminar los archivos
							$.cookie("PesoVar",PesoVar);
			...
			//Tomando la captura del resultado.
				$('#ContainerBar').html2canvas({
					onrendered: function (canvas) 
					{
						...
						$.post( "modulos/Biotest/Funciones.php", { Params: Params,  } ).done(function (response){
							var objJSON = eval("(function(){return " + response + ";})()");
							IMCVar = objJSON.IMCVar; //Nombre del archivo de condición física
							//Se crea la cookie para mandarlas al pdf y luego eliminar los archivos
							$.cookie("IMCVar",IMCVar);
		...
		if(confirmacion == true){
				...
				$('#ContainerBar').html2canvas({
					onrendered: function (canvas) 
					{
						...
						$.post( "modulos/Biotest/Funciones.php", { Params: Params,  } ).done(function (response){
							var objJSON = eval("(function(){return " + response + ";})()");
							StaminaVar = objJSON.StaminaVar; //Nombre del archivo de condición física
							//Se crea la cookie para mandarlas al pdf y luego eliminar los archivos
							$.cookie("StaminaVar",StaminaVar);
							window.location='index.php?nav=Fuerza&id='+id_cliente;							
						}); //end jquery post
			...
			//Tomando la captura del resultado.
				$('#ContainerBar').html2canvas({
					onrendered: function (canvas) 
					{
						...
						$.post( "modulos/Biotest/Funciones.php", { Params: Params,  } ).done(function (response){
							var objJSON = eval("(function(){return " + response + ";})()");
							FuerzaVar = objJSON.FuerzaVar; //Nombre del archivo de condición física
							//Se crea la cookie para mandarlas al pdf y luego eliminar los archivos
							$.cookie("FuerzaVar",FuerzaVar);
							window.location='index.php?nav=Resistencia&id='+id_cliente;						
						}); //end jquery post
			...
			//Tomando la captura del resultado.
				$('#ContainerBar').html2canvas({
					onrendered: function (canvas) 
					{
						...
						$.post( "modulos/Biotest/Funciones.php", { Params: Params,  } ).done(function (response){
							var objJSON = eval("(function(){return " + response + ";})()");
							ResistenciaVar = objJSON.ResistenciaVar; //Nombre del archivo de condición física
							//Se crea la cookie para mandarlas al pdf y luego eliminar los archivos
							$.cookie("ResistenciaVar",ResistenciaVar);
							window.location='index.php?nav=Flexibilidad&id='+id_cliente;					
						}); //end jquery post
		...
		if(confirmacion == true){
				...
				$('#ContainerBar').html2canvas({
					onrendered: function (canvas) 
					{
						...
						$.post( "modulos/Biotest/Funciones.php", { Params: Params,  } ).done(function (response){
							var objJSON = eval("(function(){return " + response + ";})()");
							FlexibilidadVar = objJSON.FlexibilidadVar; //Nombre del archivo de condición física
							//Se crea la cookie para mandarlas al pdf y luego eliminar los archivos
							$.cookie("FlexibilidadVar",FlexibilidadVar);
...
function EnviarResultadosBiotest()
{
	...
	var Arr = new Object();	
	Arr['Id_Cliente']		  = Id_Cliente;
	Arr['CondicionFisicaVar'] = $.cookie("CondicionFisicaVar");
	Arr['PesoVar']			  = $.cookie("PesoVar");
	Arr['IMCVar'] 			  = $.cookie("IMCVar");
	Arr['IMMVar'] 			  = $.cookie("IMMVar");
	Arr['StaminaVar']		  = $.cookie("StaminaVar");
	Arr['FuerzaVar']		  = $.cookie("FuerzaVar");
	Arr['ResistenciaVar']	  = $.cookie("ResistenciaVar");
	Arr['FlexibilidadVar']	  = $.cookie("FlexibilidadVar");
	Arr['Folder_Name']	 	  = $.cookie("Folder_Name");
	Arr['Accion']			  = "CrearPdf";
	console.log(Arr);
	var Params= JSON.stringify(Arr);
