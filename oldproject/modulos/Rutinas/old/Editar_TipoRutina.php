<?php
	...
	if(isset($_SESSION['Sesion']) && $_SESSION['Sesion']['id_usuario']!="")
	{
		if(isset($_GET['id']))
		{
			...
			$consultar=new Consultar();
			$result=$consultar->_ConsultarTipoRutinaPorId($id);
...
.Botones {margin-right: 4%;}
  ...
  <strong>Bien Hecho!</strong> Tipos De Rutina Editado.</div>
							...
							<div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nb_TipoRutina" id="nb_TipoRutina" campo="Nombres" class="form-control requerido" 
                                        placeholder="Nombre de Tipo de rutina" value="<?php echo $fila['nb_TipoRutina'];?>">
                                        <input type="hidden" id="id_TipoRutina" value="<?php echo $fila['id']?>">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="nb_apellidos">Descripci&oacute;n</label>
                                        <textarea name="desc_TipoRutina" id="desc_TipoRutina" class="form-control requerido"><?php echo $fila['desc_TipoRutina']?></textarea>
                                    </div>
