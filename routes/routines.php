<?php 
	...
	$app->get("/routines/filters[/{params:.*}]",function(ServerRequestInterface $request, ResponseInterface $response) use($app){
			try {
				...
				if(!$dataResponse['error'])
				{
					// Getting the information.
					$routinesController = new routinesController();
					$dataResponse = $routinesController->ConsultarRutinasFiltradas($params);
				}
